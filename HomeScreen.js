      ...
      <View style={{ width: "90%" }}>
        ...
        <View style={styles.workoutInfoContainer}>
          <View style={styles.infoBox}>
            <Image
              source={require("./assets/images/time-64.png")}
              style={styles.iconImg}
            />
            <Text style={styles.nameText}>{Math.round(props.route.params.time/60)}</Text>
            <Text style={styles.infoType}>minutes</Text>
          </View>
          <View style={{ gap: 10, flex: 1.4 }}>
            ...
            >
               <Image
                source={require("./assets/images/in-progress-icon.png")}
        ...
        <TouchableOpacity style={styles.button} onPress={()=>props.navigation.push('SelectScreen')}><Text style={styles.text}>Start Workout</Text></TouchableOpacity>
      </View>
